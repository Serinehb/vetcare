...
export default function AdminPage() {
  ...
  /* Scroll lock for the messaging side-panel too */
  useEffect(() => {
    if (messagingOpen) {
      const scrollY = window.scrollY;
      document.body.style.top = `-${scrollY}px`;
      document.body.dataset.scrollYMsg = String(scrollY);
      document.body.classList.add("modal-open");
    } else if (document.body.dataset.scrollYMsg !== undefined) {
      const scrollY = Number(document.body.dataset.scrollYMsg || "0");
      document.body.classList.remove("modal-open");
      document.body.style.top = "";
      delete document.body.dataset.scrollYMsg;
      window.scrollTo(0, scrollY);
    }
  }, [messagingOpen]);
  ...
  const notifCount = soonAppointments.length + unseenClients.length + newClientNotifs.length;
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f4f7f6]">
        ...
        <div className="flex items-center justify-between gap-3 px-[5%] py-4">
          <div className="flex items-center gap-4 min-w-0">
            <button
              ...
              className="lg:hidden w-10 h-10 flex items-center justify-center text-xl text-[#333] shrink-0"
            >
              <i className="fa-solid fa-bars" />
            </button>
            <Link href="/" className="logo-link text-2xl font-bold flex items-center gap-2 text-[#333] cursor-pointer shrink-0">
              <i className="fa-solid fa-shield-halved logo-paw" />
              <span>VetCare <span className="text-sm font-normal text-[#888]">Admin</span></span>
            </Link>
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <div ref={searchRef} className="relative">
              ...
              <button
                ...
                className="md:hidden w-10 h-10 rounded-full flex items-center justify-center text-[#333] hover:bg-[#f4f7f6] transition-colors"
              >
                <i className="fa-solid fa-magnifying-glass" />
              </button>
              {searchOpen && (
                <div className="absolute right-0 mt-3 w-[90vw] max-w-[380px] max-h-[70vh] overflow-y-auto bg-white rounded-[20px] shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-[#eee] z-50">
                  {!hasSearchResults ? (
            ...
            <button
              ...
              className="relative w-10 h-10 rounded-full flex items-center justify-center text-[#333] hover:bg-[#f4f7f6] transition-colors"
            >
              <i className="fa-solid fa-comments" />
              {unseenClients.length > 0 && (
            ...
            <div ref={notifRef} className="relative">
              ...
              {notifOpen && (
                <div className="absolute right-0 mt-3 w-[320px] bg-white rounded-[20px] shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-[#eee] z-50 overflow-hidden">
                      ...
                      <>
                        ...
                        {newClientNotifs.map((n) => (
                          ...
                          >
                            ...
                            <span className="text-sm text-[#666]">Nouvelle inscription : <span className="font-semibold text-[#333]">{n.name}</span></span>
                          </button>
                        ))}
                        {unseenClients.map((c) => (
                          <button key={c.email} type="button" onClick={() => openMessagingWith(c.email)} className="w-full text-left px-5 py-3 flex items-start gap-3 hover:bg-[#f4f7f6] transition-colors border-b border-[#eee] last:border-b-0">
                            <span className="w-8 h-8 shrink-0 rounded-full bg-[rgba(44,140,153,0.1)] text-[#2c8c99] flex items-center justify-center text-xs">
                              <i className="fa-solid fa-comment-dots" />
                            </span>
                            <span className="text-sm text-[#666]">Nouveau message de {c.name}</span>
                          </button>
                        ))}
                      </>
                    )}
            ...
            <div ref={userMenuRef} className="relative">
              <button
                ...
                className="flex items-center gap-2 pl-1 pr-3 py-1 rounded-full hover:bg-[#f4f7f6] transition-colors"
              >
                <img src={admin.img} alt={admin.name} className="w-8 h-8 rounded-full object-cover" />
                <span className="hidden sm:block text-sm font-medium text-[#333]">{admin.name.split(" ").pop()}</span>
                <i className="fa-solid fa-chevron-down text-[10px] text-[#888]" />
              </button>
              {userMenuOpen && (
          ...
          <div className="md:hidden px-[5%] pb-4">
            <div className="flex items-center gap-2.5 px-4 py-2.5 rounded-full bg-[#f4f7f6]">
              ...
              <input
                ...
                className="flex-1 bg-transparent text-sm text-[#333] placeholder:text-[#888] focus:outline-none"
                autoFocus
              />
            </div>
          </div>
      ...
      <div className="flex flex-1 min-h-0">
        {/* ── DESKTOP SIDEBAR ── */}
        <aside className="hidden lg:block w-64 shrink-0 bg-white border-r border-[#eee] sticky top-[65px] self-start">
      ...
      <div
        className={`mobile-menu-panel fixed top-0 left-0 h-full w-full max-h-[88vh] overflow-y-auto no-scrollbar bg-white shadow-[0_20px_50px_rgba(0,0,0,0.2)] flex flex-col p-6 gap-2 rounded-b-[24px] z-[1010] transform transition-transform duration-300 ease-out ${
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <button type="button" onClick={() => setSidebarOpen(false)} aria-label="Fermer" className="w-9 h-9 rounded-full bg-[#f4f7f6] text-[#888] flex items-center justify-center hover:bg-[#2c8c99] hover:text-white transition-all">
      ...
      <main className="flex-1 p-6 lg:p-10 max-w-[1200px] mx-auto w-full">
        <div className="mb-8">
          <h1 className="text-2xl md:text-3xl font-bold text-[#333]">{tabTitles[tab].title}</h1>
          <p className="text-sm text-[#888] mt-1">{tabTitles[tab].subtitle}</p>
        </div>
            ...
            <div className="px-5 pt-3 pb-4 border-t border-[#eee] shrink-0">
              ...
              >
                ...
                <input
                  ...
                  className="flex-1 px-4 py-3 rounded-full border border-[#ddd] text-sm bg-[#f4f7f6] focus:outline-none focus:border-[#2c8c99] focus:bg-white transition-colors"
                />
                <button
                  type="submit"
                  aria-label="Envoyer"
                  ...
                  {activeThreadClient ? (
                    <>
                      ...
                      <div className="px-5 py-3 border-t border-[#eee] shrink-0 bg-white">
                        <div className="flex items-center gap-3">
                          ...
                          <input type="text" value={threadDraft} onChange={(e) => setThreadDraft(e.target.value)} placeholder={`Écrire à ${activeThreadClient.name}…`} className="flex-1 px-4 py-2.5 rounded-full border border-[#ddd] text-sm bg-[#f4f7f6] focus:outline-none focus:border-[#2c8c99] focus:bg-white transition-colors" />
                    ...
                    <>
                      ...
                      <div className="px-5 py-3 border-t border-[#eee] shrink-0 bg-white">
                        <div className="flex items-center gap-3">
                          {admin && <img src={admin.img} alt={admin.name} className="w-8 h-8 shrink-0 rounded-full object-cover" />}
                          <input type="text" value={stagThreadDraft} onChange={(e) => setStagThreadDraft(e.target.value)} placeholder={`Écrire à ${activeStagiaireThread.name}…`} className="flex-1 px-4 py-2.5 rounded-full border border-[#ddd] text-sm bg-[#f4f7f6] focus:outline-none focus:border-[#2c8c99] focus:bg-white transition-colors" />
