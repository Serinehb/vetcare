...
const autoReplies = [
  ...
  "Bien reçu — nous regardons ça et vous répondons dans la journée.",
  "Merci ! Pensez à préciser le nom de votre animal si besoin, on s'en occupe.",
];
...
export default function MessagingPanel({
  ...
  const handleSend = (e: FormEvent<HTMLFormElement>) => {
    ...
    window.setTimeout(() => {
      ...
      const withReply = addMessage(withUserMsg, {
        from: "team",
        author: activeVet,
        text: reply,
        with: activeVet,
